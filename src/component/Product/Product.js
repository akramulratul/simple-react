...
const Product = (props) => {
 ...
 const [hired, setHired] = useState(false);
    return (
        <div className="all-players product rounded p-3 m-3 col-lg-9">
            ...
            <div>
                ...
                <div className="d-flex buttonPlace">
                    <div>
                        <button onClick={() => {props.handleAddProduct(props.product); setHired(true);}} className={hired ? "btn-disable":"btn-success"}>
